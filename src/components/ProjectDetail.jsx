...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // Ambil data project dari array manual (hardcode di sini atau import dari file lain jika perlu)
    const projects = [
      {
        id: 1,
        ...
        Features: [
          "Daftar dan detail properti",
          "Formulir pemesanan & kontak dinamis",
          "Filter dan pencarian properti",
          "Halaman admin untuk CRUD data properti",
      ...
      },
      {
        ...
        Features: [
          ...
          "Akun demo role admin (admin@gmail.com / admin123)",
