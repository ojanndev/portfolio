...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/fauzan-nasyruddin-993132313/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ojann.ae",
    icon: Instagram,
    url: "https://www.instagram.com/ojann.ae/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "+62 895-3394-54561",
    icon: ({ className, ...props }) => (
      <svg className={className} {...props} width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="16" cy="16" r="16" fill="#25D366"/>
        <path d="M23.472 19.339c-.355-.177-2.104-1.037-2.43-1.155-.326-.119-.563-.177-.8.177-.237.355-.914 1.155-1.122 1.392-.208.237-.414.266-.769.089-.355-.178-1.5-.553-2.858-1.763-1.056-.943-1.77-2.104-1.98-2.459-.208-.355-.022-.546.156-.723.16-.159.355-.414.533-.622.178-.208.237-.355.355-.592.119-.237.06-.444-.03-.622-.089-.178-.8-1.924-1.095-2.637-.288-.692-.581-.597-.8-.608-.208-.009-.444-.011-.68-.011-.237 0-.622.089-.948.444-.326.355-1.24 1.211-1.24 2.955 0 1.744 1.27 3.428 1.447 3.666.178.237 2.5 3.82 6.063 5.209.849.292 1.51.466 2.027.596.851.204 1.626.175 2.238.106.682-.076 2.104-.859 2.402-1.689.297-.83.297-1.541.208-1.689-.089-.148-.326-.237-.681-.414z" fill="#fff"/>
      </svg>
    ),
    url: "https://wa.me/62895339454561",
    color: "#25D366",
...
const SocialLinks = () => {
  ...
  const [instagram, whatsapp, github, tiktok] = otherLinks;
